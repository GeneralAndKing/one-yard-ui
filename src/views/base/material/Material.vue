...
export default {
  ...
  data: () => ({
    ...
    materialType: [],
    headers: [
      { text: '物料名称', value: 'name', align: 'left' },
      { text: '物料编码', value: 'code', align: 'left' },
      { text: '物料分类编码', value: 'materialTypeCode', align: 'left' },
      { text: '物料分类名称', value: 'materialTypeName', align: 'left' },
      { text: '规格', value: 'specifications', align: 'left' },
      { text: '型号', value: 'size', align: 'left' },
      { text: '计量单位', value: 'unit', align: 'left' },
      { text: '库存数量', value: 'number', align: 'left' },
      { text: '采购提前期/天', value: 'procurementLeadTime', align: 'left' },
      { text: '排序', value: 'sort' },
